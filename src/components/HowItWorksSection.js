...
function HowItWorksSection() {
    return (
        <section id="how-works-section" className="how-works-section position-relative">
            <div className="container">
                <h5 className="heading">How it Works</h5>
                <p className="content mt-2">From setup to success in <span>4 simple steps</span></p>
                <div className="row mt-4 lead-crm-card-bg">
                    <div className="col-12 col-md-6 col-lg-3">
                        <div className="card">
                            ...
                            <img src="/images/card-1-img.png" alt="card-1" className="card-img"/>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-3 mt-5 mt-md-0">
                        <div className="card">
                            ...
                            <img src="/images/card-2-img.png" alt="card-1" className="card-img"/>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-3 mt-5 mt-lg-0">
                        <div className="card">
                            ...
                            <img src="/images/card-3-img.png" alt="card-1" className="card-img"/>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-3 mt-5 mt-lg-0">
                        <div className="card">
                            ...
                            <img src="/images/card-4-img.png" alt="card-1" className="card-img"/>
                        </div>
                    </div>
            ...
            <img src="/images/ball.png" className="position-absolute end-0" style={{ bottom: '-50px' }} alt="ball"/>
        </section>
    )
}
